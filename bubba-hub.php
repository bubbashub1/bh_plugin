...
if (!defined('BH_PLUGIN_VERSION')) {
    define('BH_PLUGIN_VERSION', '1.4.3');
}
...
require_once BH_PLUGIN_DIR . 'includes/class-bh-directorist-fields.php';
...
require_once BH_PLUGIN_DIR . 'includes/class-bh-planner.php';
